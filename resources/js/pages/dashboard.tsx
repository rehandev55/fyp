...
export default function Dashboard({ progressSummary, recentActivities }: any){
    ...
    const quickActions = [
        { label: 'Ask AI', desc: 'Chat with AI tutor', href: '/aichat', icon: 'fa-solid fa-robot', gradient: 'from-blue-500 to-indigo-600' },
        { label: 'Start Practice', desc: 'Take a quiz', href: '/practice', icon: 'fa-solid fa-clipboard-check', gradient: 'from-emerald-500 to-teal-600' },
        { label: 'View Resources', desc: 'Download materials', href: '/resources', icon: 'fa-solid fa-book-open', gradient: 'from-purple-500 to-pink-600' },
    ];
            ...
            <div className="space-y-8">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                        {quickActions.map((a) => (
                            <Link key={a.label} href={a.href} className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 flex items-center gap-4 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group text-left relative overflow-hidden">
...
Dashboard.layout = (page: React.ReactNode) => <StudentLayout currentPage="dashboard">{page}</StudentLayout>;
