 ...
 * @see app/Http/Controllers/AIControllers/ChatController.php:18
 ...
 * @see app/Http/Controllers/AIControllers/ChatController.php:25
 ...
 * @see app/Http/Controllers/AIControllers/ChatController.php:76
 * @route '/api/chat/{id}'
 */
