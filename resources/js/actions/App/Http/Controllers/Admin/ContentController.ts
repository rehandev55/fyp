 ...
 * @see app/Http/Controllers/Admin/ContentController.php:18
 * @route '/api/content'
 */
 ...
 * @see app/Http/Controllers/Admin/ContentController.php:49
 * @route '/api/content'
 */
 ...
 * @see app/Http/Controllers/Admin/ContentController.php:71
