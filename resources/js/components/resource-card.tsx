...
export default function ResourceCard({ title, description, subject, classLevel,downloads,onDownload }: Props) {
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
      ...
      <div className="p-5">
        ...
        <button onClick={onDownload} className="w-full bg-gradient-to-r from-[#2563EB] to-[#3B82F6] text-white py-2.5 rounded-xl hover:shadow-md transition text-sm font-medium flex items-center justify-center gap-2">
