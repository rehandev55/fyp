function ResourceCard({ title, description, subject, classLevel }) {
  const colors = { Physics: "from-blue-500 to-cyan-500", Chemistry: "from-purple-500 to-pink-500", Biology: "from-green-500 to-emerald-500", Mathematics: "from-orange-500 to-amber-500", English: "from-rose-500 to-red-500" };
