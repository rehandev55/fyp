...
function About() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <div>
        <div className="text-center mb-6"><span className="text-sm font-semibold text-[#2563EB] bg-blue-50 dark:bg-blue-900/30 px-4 py-1.5 rounded-full">Our Team</span></div>
